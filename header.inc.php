    ...
    <div class="header">
        ...
        <div class="politiek">
            <a class="header_icons" href="politiek.php">
                <svg class="header_icon" xmlns="http://www.w3.org/2000/svg" width="65" height="65" viewBox="0 0 14 14">
        ...
        <div class="economie">
            <a class="header_icons" href="economie.php">
                ...
                <svg class="header_icon" xmlns="http://www.w3.org/2000/svg" width="65" height="65" viewBox="0 0 24 24">
        ...
        <div class="gezondheid">
           <a class="header_icons" href="gezondheid.php">
                ...
                <svg class="header_icon" xmlns="http://www.w3.org/2000/svg" width="65" height="65" viewBox="0 0 48 48">
